  ...
  <div class="container mt-4">
    ...
    <form>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-8">
          <select class="form-select" v-model="form.operateur">
            <option disabled value="">-- Sélectionner --</option>
            <option v-for="item in operateurs" :key="item" :value="item">{{ item }}</option>
          </select>
        </div>
      </div>
...
const lots = ref([])
const operateurs = ['TLA', 'JPN', 'MRA', 'KLM']
