    ...
    <div class="container mt-4">
        ...
        <form>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                    <select class="form-select" v-model="form.typePieces" required>
                        <option disabled value="">-- Sélectionner --</option>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" v-model="form.num_lot_wafer" placeholder="Ex : WAF123456"
                        required />
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                    <select class="form-select" v-model="form.operateur" required>
                        <option disabled value="">-- Sélectionner --</option>
                        <option v-for="item in options.operateur" :key="item" :value="item">{{ item }}</option>
                    </select>
                </div>
            </div>
...
const options = {
    activity: ['Prod', 'Test', 'Qualité'],
    typePieces: ['SK', 'PK', 'MK', 'TK'],
    versionPiece: ['A00', 'B01', 'C02'],
    imprimante: ['M031', 'M045', 'M078'],
    operateur: ['TLA', 'JPN', 'MRA', 'KLM']
}
