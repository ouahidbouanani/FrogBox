...
// Charger les lots dynamiquement
const fetchLots = async () => {
    try {
        const response = await axios.get('http://localhost:3000/api/debut-tomo-finis/lots')
...
const submitForm = async () => {
    try {
        ...
        await axios.post('http://localhost:3000/api/debut-tomo-finis', payload)
