  ...
  <div class="card">
    ...
    <div class="card-body py-0 mb-2" data-simplebar style="max-height: 388px;">
      ...
      <div class="d-flex align-items-center mb-3">
        ...
        <div class="flex-grow-1 ms-2">
          <a href="javascript:void(0);" class="h4 my-0 fw-semibold text-reset">Behance <i
              class="mdi mdi-check-decagram text-muted ms-1"></i></a>
        </div>
        <a href="javascript:void(0);" class="font-16 text-muted"><i class="uil uil-angle-right-b"></i></a>
      </div>
      ...
      <div class="d-flex align-items-center mb-3">
        ...
        <div class="flex-grow-1 ms-2">
          <a href="javascript:void(0);" class="h4 my-0 fw-semibold text-reset">Github <i
              class="mdi mdi-check-decagram text-muted ms-1"></i></a>
        </div>
        <a href="javascript:void(0);" class="font-16 text-muted"><i class="uil uil-angle-right-b"></i></a>
      </div>
      ...
      <div class="d-flex align-items-center mb-3">
        <div class="flex-shrink-0">
          <div class="avatar-sm rounded">
            <span class="avatar-title bg-transparent border border-light text-success rounded h3 my-0">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-google"
                   viewBox="0 0 16 16">
                <path
        ...
        <div class="flex-grow-1 ms-2">
          <a href="javascript:void(0);" class="h4 my-0 fw-semibold text-reset">Google <i
              class="mdi mdi-check-decagram text-muted ms-1"></i></a>
        </div>
        <a href="javascript:void(0);" class="font-16 text-muted"><i class="uil uil-angle-right-b"></i></a>
      </div>
