...
const selectedPosition = ref("bas_droit"); 
...
const downloadFile = () => {
    ...
    const originalFileName = selectedFile.value.name.replace(/\.pdf$/, ""); 
    link.setAttribute("download", `${originalFileName}_numéroté.pdf`); 
