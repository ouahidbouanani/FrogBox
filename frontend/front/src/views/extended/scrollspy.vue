  ...
  <Layout>
    ...
    <b-row>
      <b-col cols="12">
        ...
        <CustomSyntax title="Example in navbar">
          ...
          <template v-slot:preview>
            ...
            >
              ...
              <p>
                ...
                they sold out, terry richardson proident brunch nesciunt quis
                cosby sweater pariatur keffiyeh ut helvetica artisan. Cardigan
    ...
    <b-row>
      <b-col cols="12">
        ...
        <CustomSyntax title="Example with nested nav">
          <template v-slot:sub-text>
              ...
              <b-col cols="10">
                ...
                >
                  ...
                  <p>
                    ...
                    ipsum ipsum ullamco cillum consectetur ut et aute consectetur
                    labore. Fugiat laborum incididunt tempor eu consequat enim
                    dolore proident. Qui laborum do non excepteur nulla magna
                    eiusmod consectetur in. Aliqua et aliqua officia quis et
                    incididunt voluptate non anim reprehenderit adipisicing dolore
                    ut consequat deserunt mollit dolore. Aliquip nulla enim veniam
                    non fugiat id cupidatat nulla elit cupidatat commodo velit ut
                    eiusmod cupidatat elit dolore.
                  </p>
                  <h5 id="item-1-1">Item 1-1</h5>
                  <p>
                    Amet tempor mollit aliquip pariatur excepteur commodo do ea
                    ...
                    aliqua commodo eiusmod aliquip est do duis amet proident magna
                    consectetur consequat eu commodo fugiat non quis. Enim aliquip
                    exercitation ullamco adipisicing voluptate excepteur minim
                    exercitation minim minim commodo adipisicing exercitation
                    officia nisi adipisicing. Anim id duis qui consequat labore
                  ...
                  <p>
                    ...
                    incididunt sint et culpa culpa incididunt adipisicing magna
                    magna occaecat. Nulla ipsum cillum eiusmod sint elit excepteur
                    ea labore enim consectetur in labore anim. Proident ullamco
                    ipsum esse elit ut Lorem eiusmod dolor et eiusmod. Anim
                  ...
                  <p>
                    ...
                    proident voluptate minim mollit nostrud aute reprehenderit do.
                    Mollit excepteur eu Lorem ipsum anim commodo sint labore Lorem
                    in exercitation velit incididunt. Occaecat consectetur nisi in
                    occaecat proident minim enim sunt reprehenderit exercitation
                    cupidatat et do officia. Aliquip consequat ad labore labore
                    mollit ut amet. Sit pariatur tempor proident in veniam culpa
                    aliqua excepteur elit magna fugiat eiusmod amet officia.
                  </p>
                </div>
              </b-col>
            </b-row>
    ...
    <b-row>
      <b-col cols="12">
        ...
        <CustomSyntax title="Example with list-group">
          <template v-slot:sub-text>
            Scrollspy also works with nested <code>.nav</code>s. If a nested
            <code>.nav</code> is <code>.active</code>, its parents will also be
            <code>.active</code>. Scroll the area next to the navbar and watch
...
export default {
  ...
  mounted() {
    ...
    new ScrollSpy(document.getElementById("navbar-example1")!, {
      target: "#navbar-example2",
    });
    new ScrollSpy(document.getElementById("navbar-example4")!, {
      target: "#navbar-example3",
    });
    new ScrollSpy(document.getElementById("list-example1")!, {
      target: "list-example2",
    });
  },
}
</script>