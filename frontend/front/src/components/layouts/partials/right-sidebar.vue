<template>
  <b-offcanvas v-model="useLayout.isRightSidebarOpen" title="Theme Settings"
               body-class="overflow-y-hidden p-0"
               header-class="align-items-center bg-primary  text-white" placement="end"
               id="theme-settings-offcanvas"

  >
    <template #default>
      <div class="p-0" data-simplebar style="height: 100vh">
        <div>
        ...
        <div class="row">
          ...
          <div class="col-6">
            <a href="#" target="_blank"
               role="button" class="btn btn-primary w-100">Buy Now</a>
          </div>
        </div>
      </div>
    </template>
