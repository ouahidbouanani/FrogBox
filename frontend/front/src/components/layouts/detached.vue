...
export default {
  ...
  created: function () {
    this.useLayout.config.layout.mode = 'detached'
    this.useLayout.config.topbar.color = 'dark'
    this.useLayout.config.menu.color = 'light'
    this.useLayout.config.sidenav.user = true
